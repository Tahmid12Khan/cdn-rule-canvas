...
export const NODE_TYPES_FIXTURE: NodeManifest = {
  ...
  node_types: [
      ...
      fields: [
        {
          ...
          required: true,
          default: "",
          required_message: "Pick a component",
        },
        {
          name: "version",
          label: "Version",
          control: "component_version_select",
          required: true,
          default: "default",
        },
        {
          ...
          required_message: "Enter a CSS selector",
        },
        {
          name: "placement_mode",
          label: "Placement",
    ...
    {
      kind: "apply_component_json",
      label: "Component",
      category: "json",
      applies_to: "json",
      node_kind: "expression",
      summary:
        "Render a Component template to an HTML string and set it at a JSON path.",
      fields: [
        {
          name: "component_id",
          label: "Component",
        ...
        },
        {
          ...
          required_message: "Enter a JSON path",
        },
      ],
      output: { branches: [{ id: "out", label: "Next" }] },
    },
